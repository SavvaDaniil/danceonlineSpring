package com.dancestudioSpring.DTO.ConnectionDanceGroupToUserAdmin;

import com.dancestudioSpring.Interface.ValidatedObject;

public class ConnectionDanceGroupToUserAdminUpdateDTO implements ValidatedObject {
	...
	public boolean isValid() {
		...
		return this.id_of_dance_group != 0 && this.id_of_user != 0;
	}
